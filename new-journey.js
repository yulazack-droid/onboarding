...
const app=initializeApp(firebaseConfig,"lgp-new-journey"),auth=getAuth(app),db=getFirestore(app),provider=new GoogleAuthProvider();provider.setCustomParameters({hd:"scopely.com"});
